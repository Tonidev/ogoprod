...
<div id="photo-usluga4" class="overlay" style="">
  <div class="popup kurs" style="top:10%;">
    ...
    <div class="schoolblock"><span><a
            style="padding-bottom: 1em;padding-left:5.3em;font-size: 18px;text-shadow: rgba(8,204,171,2) 0 0 10px;"
            onclick="return false;">Заняття №1</a>
    ...
    <div class="schoolblock"><span>
           <a style="padding-left:5.3em;font-size: 18px;text-shadow: rgba(8,204,171,2) 0 0 10px;"
              onclick="return false;">Заняття №2</a>
        <br>&nbsp;- ISO
        <br>&nbsp;- Витримка
        <br>&nbsp;- Apertura
    ...
    <div class="schoolblock"><span><a
            style="padding-left:5.3em;font-size: 18px;text-shadow: rgba(8,204,171,2) 0 0 10px;" onclick="return false;">Заняття №3</a>
        <br>&nbsp;- Фокусування
        <br>&nbsp;- Глибина різкості
        <br>&nbsp;- Практика</span></div>
    <div class="schoolblock"><span><a
            style="padding-left:5.3em;font-size: 18px;text-shadow: rgba(8,204,171,2) 0 0 10px;" onclick="return false;">Заняття №4</a>
        <br>&nbsp;- Робота з витримкою
        <br>&nbsp;- Практика на вулиці</span></div>
    <div class="schoolblock"><span><a
            style="padding-left:5.3em;font-size: 18px;text-shadow: rgba(8,204,171,2) 0 0 10px;" onclick="return false;">Заняття №5</a>
        <br>&nbsp;- White balance
        <br>&nbsp;- Кращі кольори сприйняття людським оком
        <br>&nbsp;- Знайомство з Лайтрумом</span></div>
    <div class="schoolblock"><span><a
            style="padding-left:5.3em;font-size: 18px;text-shadow: rgba(8,204,171,2) 0 0 10px;" onclick="return false;">Заняття №6</a>
        ...
        <br>&nbsp;- Практика</span></div>
    <div class="schoolblock"> <span><a
            style="padding-left:5.3em;font-size: 18px;text-shadow: rgba(8,204,171,2) 0 0 10px;" onclick="return false;">Заняття №7</a>
        <br>&nbsp;- Знайомство зі студійним світлом
        <br>&nbsp;- Особливості зйомки у студії
        <br>&nbsp;- Практика + д/з</span></div>
    <div class="schoolblock"><span><a
            style="padding-left:5.3em;font-size: 18px;text-shadow: rgba(8,204,171,2) 0 0 10px;" onclick="return false;">Заняття №8</a>
