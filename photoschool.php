...
<li>Групи до 10 чоловік, кожен учень отримує достатньо уваги
    ...
    <p></p>
    <a  data-usluga="photo-usluga4" onclick="$('#photo-usluga5').show();return false;" href="#" class="totton">Повний опис</a>
    <p></p>
<span style="font-family: PNG1;font-size: 18px;color: white;">
...
<br>&nbsp;Види зйомок, розподіл по жанрах, вибір  &nbsp;потрібного обладнання
        ...
        <button class="close" title="Закрыть" onclick="document.getElementById('photo-usluga5').style.display='none';"></button>
        <div>
        </div>
</div>
    </div>
